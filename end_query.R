...
# removed from line 129
# AND DATE(install_timestamp) BETWEEN DATE(DATE_ADD(DATE(current_date()), (",day_num,"*-1), 'DAY')) AND DATE(DATE_ADD(DATE(current_date()), ((",day_num,"*-1)+7), 'DAY'))

#added a condition for player age, and added back the group by 
# AND playerage <= 90
# Group By 1        
# Order by 1
